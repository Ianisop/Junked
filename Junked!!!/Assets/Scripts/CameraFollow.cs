...
public class CameraFollow : MonoBehaviour
{
    ...
    [SerializeField]float fixedHeight = .5f;
    [SerializeField] bool lockTranslation = false;
    [SerializeField][Range(0f, 360f)] float fixedTranslation = 0f;
    [SerializeField] bool avoidClipping = true;
    [SerializeField] LayerMask avoidClippingLayerMask = 0;
    [SerializeField] float clipDistance = 5f;
    [SerializeField] float clippingOffset = 0f;
